...
write_csv(canada_table_pct, here("03_output/02_tables/Table3_percent_multilingual_by_characteristic_all_Canada.csv"))
...
write_csv(canada_table_prob, here("03_output/02_tables/Table4_probabilities_all_Canada.csv"))
```
