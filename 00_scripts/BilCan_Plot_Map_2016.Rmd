...
ggsave(here::here("03_output","01_figures","canada_map_simplified.pdf"), 
        width = 6.75, 
...
## greyscale map
```{r}
map_plot + scale_fill_gradient(low = "white", high = "grey27", 
                       labels = scales::percent_format(accuracy = 1), 
                       name=legend_label, 
                       breaks = seq(0.0,0.35, by = 0.1))

ggsave(here::here("03_output","01_figures","canada_map_greyscale_simplified.pdf"), 
        width = 6.75, 
        height = 4.725, dpi = 300, unit = "in")
```
