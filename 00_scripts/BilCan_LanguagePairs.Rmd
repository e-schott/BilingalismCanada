...
# Table 2.2: look at languages by province
# calculate totals 
...
## write table to csv
```{r}
province_language_pair_data$province[duplicated(province_language_pair_data$province)] <- ""
...
Table_2.3 %>%
  write_excel_csv(here("03_output", "02_tables", "TableS1_language_pairs_by_area_for_computer.csv"))
