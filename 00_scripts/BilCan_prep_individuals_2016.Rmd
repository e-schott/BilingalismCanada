...
## Script settings
```{r}
load_data_from_raw = FALSE # If true, loads data from .sav, else loads R file (the latter is faster)
...
The response options in the language questions are super long, cut them down to only TRUE/FALSE
```{r}
