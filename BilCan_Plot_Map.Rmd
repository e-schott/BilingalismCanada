...
# other map
```{r}
good_labels = c( "Calgary", "Edmonton",  "Halifax", 
"Hamilton", "Kelowna", "Kingston", "London", "Moncton", 
...
geom_label_repel(data          = subset(gma_labels, short_label %in% good_labels ),
                    aes(x= long, y= lat, label = short_label), size =5 ,
                 alpha = 0.75 , seed=1234)
  
 ggsave(here::here("03_output","01_figures","canada_map_transparent_labels.png"), width = 13, height =7)

#,
#   nudge_x       = 9195936-  subset(gma_labels, long > cutoff)$long,
 #   segment.size  = 1,
  #  segment.color = "grey50",
   # direction     = "both",
    #vjust         = 1
  # ) +
  # geom_text_repel(data          = subset(gma_labels, long < cutoff),
  #                   aes(x= long, y= lat, label = short_label, group=NULL),
  #   nudge_y       = 950425 - subset(gma_labels, long < cutoff)$lat,
  #   segment.size  = 1,
  #   segment.color = "grey50",
  #   direction     = "both",
  #   vjust         = 1
